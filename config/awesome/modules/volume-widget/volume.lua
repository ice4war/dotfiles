...
-- https://github.com/streetturtle/modules/tree/master/volume-widget
...
local utils = require("modules.volume-widget.utils")
...
local widget_types = {
    icon_and_text = require("modules.volume-widget.widgets.icon-and-text-widget"),
    icon = require("modules.volume-widget.widgets.icon-widget"),
    arc = require("modules.volume-widget.widgets.arc-widget"),
    horizontal_bar = require("modules.volume-widget.widgets.horizontal-bar-widget"),
    vertical_bar = require("modules.volume-widget.widgets.vertical-bar-widget"),
}
local volume = {}
