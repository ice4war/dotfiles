...
local themes_path = "~/.config/awesome/themes/subzero/"
local rnotification = require("ruled.notification")
local dpi = require("beautiful.xresources").apply_dpi

-- {{{ Main
local theme = {}
theme.wallpaper = themes_path .. "wallpapers/background"
-- }}}
...
theme.border_color_active = "#6286AA"
theme.border_color_normal = "#3A4050"
theme.border_color_marked = "#BF606B"
-- }}}
...
-- {{{ Misc
theme.awesome_icon           = themes_path .. "icons/fedora.svg"
